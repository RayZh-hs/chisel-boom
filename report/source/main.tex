...
After migrating to unified DRAM, read and write has become more expensive when they cover consecutive bytes. Adding a cache revived the project to nearly the performance from before the DRAM refactor.
